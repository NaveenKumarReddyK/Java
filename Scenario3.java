...
class Person{
    ...
    double weight;
    String blood;
    Person(String name,int age,double height,double weight,String blood){
        this.name = name;
        this.age = age;
        this.height = height;
        this.blood = blood;
...
public class  Scenario3 {
    public static void main(String[] args){
        ...
        for(int i=0;i<n;i++){
                ...
                p[i] = new Person(name,age,height,weight,blood);
                double w = p[i].idealweigth();
                System.out.println("Your weight shold be:"+w);
                if(weight<w){
                    double x = w-weight;
